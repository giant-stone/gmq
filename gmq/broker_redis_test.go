...
func TestAll(t *testing.T) {
	...
	DeleteAgoTest(t, client)
	PauseAndResumeTest(t, client)
	FailTest(t, client)
}

func PauseAndResumeTest(t *testing.T, rdb *redis.Client) {
...
func FailTest(t *testing.T, rdb *redis.Client) {
	broker := getTestBroker(t)
	defer broker.Close()
...
func DeleteAgoTest(t *testing.T, rdb *redis.Client) {
	broker := getTestBroker(t)
	defer broker.Close()
	mux := gmq.NewMux()
